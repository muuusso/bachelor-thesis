...
Fromalized in a mathematical way, a system can be described by a \textit{n}-vectormodel when it can be imagined as  composed of \textit{n}-dimensional spins as unit-length vectors,
